...
class PageColModulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create page_col_module" do
    assert_difference('PageColModule.count') do
      post page_col_modules_url, params: { page_col_module: { moduleable_id: @page_col_module.moduleable_id, moduleable_type: @page_col_module.moduleable_type, page_col_id: @page_col_module.page_col_id, position: @page_col_module.position } }
    end
  ...
  test "should update page_col_module" do
    patch page_col_module_url(@page_col_module), params: { page_col_module: { moduleable_id: @page_col_module.moduleable_id, moduleable_type: @page_col_module.moduleable_type, page_col_id: @page_col_module.page_col_id, position: @page_col_module.position } }
