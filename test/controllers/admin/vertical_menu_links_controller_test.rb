...
class Admin::VerticalMenuLinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create admin_vertical_menu_link' do
    assert_difference('Admin::VerticalMenuLink.count') do
      post(
        admin_vertical_menu_links_url,
        params: {
          admin_vertical_menu_link: {
            active: @admin_vertical_menu_link.active,
            admin_vertical_menu_content_id: @admin_vertical_menu_link.admin_vertical_menu_content_id,
            background_color: @admin_vertical_menu_link.background_color,
            color: @admin_vertical_menu_link.color,
            page_id: @admin_vertical_menu_link.page_id,
            title: @admin_vertical_menu_link.title,
            url: @admin_vertical_menu_link.url
          }
        }
      )
    end
  ...
  test 'should update admin_vertical_menu_link' do
    patch(
      admin_vertical_menu_link_url(@admin_vertical_menu_link),
      params: {
        admin_vertical_menu_link: {
          active: @admin_vertical_menu_link.active,
          admin_vertical_menu_content_id: @admin_vertical_menu_link.admin_vertical_menu_content_id,
