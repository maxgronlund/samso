...
class Admin::CsvImportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_csv_import" do
    assert_difference('Admin::CsvImport.count') do
      post admin_csv_imports_url, params: { admin_csv_import: { comments: @admin_csv_import.comments, import_type: @admin_csv_import.import_type, name: @admin_csv_import.name, summary: @admin_csv_import.summary } }
    end
  ...
  test "should show admin_csv_import" do
    get admin_csv_import_url(@admin_csv_import)
    assert_response :success
  end

  test "should get edit" do
    get edit_admin_csv_import_url(@admin_csv_import)
    assert_response :success
  end

  test "should update admin_csv_import" do
    patch admin_csv_import_url(@admin_csv_import), params: { admin_csv_import: { comments: @admin_csv_import.comments, import_type: @admin_csv_import.import_type, name: @admin_csv_import.name, summary: @admin_csv_import.summary } }
  ...
  test "should destroy admin_csv_import" do
    assert_difference('Admin::CsvImport.count', -1) do
      delete admin_csv_import_url(@admin_csv_import)
    end
