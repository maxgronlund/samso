class ScaffoldModuleGenerator < Rails::Generators::NamedBase
  ...
  def generate_views
    template 'views/admin/page_link_modules/_show.erb', "app/views/admin/#{plural_name}_modules/_show.slim"
    template 'views/admin/page_link_modules/edit.erb', "app/views/admin/#{plural_name}_modules/edit.slim"
    template 'views/page_link_modules/_show.erb', "app/views/#{plural_name}_modules/_show.slim"
